...
@section('content')
    ...
    <section class="faq-section padding-top padding-bottom mt-5">
        <div class="container">
                            ...
                            <div class="faq--area">
                                ...
                                <div class="faq--item">
                                    ...
                                    <div class="faq-content">
                                        <p>You will need to buy the PipskomeEA robot.</p>
                                    </div>
                                </div>
                                ...
                                <div class="faq--item">
                                    ...
                                    <div class="faq-content">
                                        <p>Yes and No. Yes is when you do not use my recommendations and settings.  No when you stick to my recommendation and settings you won't lose your money.</p>
                                    </div>
                                </div>
                                ...
                                <div class="faq--item">
                                    ...
                                    <div class="faq-content">
                                        <p>Your role is to sit and monitor your trading account to see how much you have earn as profit.</p>
                                    </div>
                                </div>
                                ...
                                <div class="faq--item">
                                    ...
                                    <div class="faq-content">
                                        <p>No installation must be on a laptop.  But after the installation you can off the laptop and monitor your trades on your mobile phone.</p>
                                    </div>
                                </div>
